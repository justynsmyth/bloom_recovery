  ...
  return (
    <div className="page-shell">
      ...
      >
        <div ref={chromeRef} className="hero-chrome">
          ...
          <header className="site-header">
            ...
            <a className="cta-link" href="#plans">
              Start trial
            </a>
          </header>
        </div>

        <a className="floating-join-button" href="#plans">
          Join Now
        </a>
      </motion.div>
      ...
      <main>
        ...
        <section className="bundle-section" id="why-bloom-recovery">
